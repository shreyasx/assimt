...
export default function VisualAgents() {
	...
	return (
		<Box
			sx={{
				background:
					"linear-gradient(135deg, #0c0c2e 0%, #1a1a4a 50%, #252561 100%)",
				py: 8,
				px: 4,
				textAlign: "center",
				color: "white",
        ...
        .slick-center .agent-card {
          box-shadow: 0 30px 80px rgba(90, 90, 255, 0.5) !important;
          transform: translateY(0) !important;
        }
        .slick-slide:not(.slick-center) .agent-card {
							...
							>
								...
								<Box
									sx={{
										...
										right: 0,
										background:
											"linear-gradient(to top, rgba(12, 12, 46, 0.95) 0%, rgba(26, 26, 74, 0.7) 50%, transparent 100%)",
										color: "#fff",
										p: 3,
										pt: 6,
										display: "flex",
